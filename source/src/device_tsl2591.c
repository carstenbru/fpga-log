...
void device_tsl2591_init(device_tsl2591_t* const tsl2591,
	...
	unsigned char control[2] = { TLS2591_REGISTER_CONFIG, 0b00000000 | (gain << 4)
			| (integration_time) };
	...
	unsigned char persist[2] = { TLS2591_REGISTER_PERSIST, 0b00000000 };
	...
	unsigned char enable[2] = { TLS2591_REGISTER_ENABLE, 0b10010011 };
...
static void device_tsl2591_send_data(void* const _tsl2591,
	...
	unsigned char set_register = 0b10100000 | TLS2591_REGISTER_C0DATAL;
	...
	i2c_action_w_retry(tsl2591->i2c_master, TSL2591_ADDRESS, 4, val_buf, i2c_read,
	TSL2591_I2C_RETRIES);  //read the data from the device

	unsigned char clear_int = 0b10100111;
	...
	data_package_t ch0_package = { tsl2591->super.id, "ch0", DATA_TYPE_INT,
			&ch0_val, timestamp };
	tsl2591->ch0_out->new_data(tsl2591->ch0_out->parent, &ch0_package);
	data_package_t ch1_package = { tsl2591->super.id, "ch1", DATA_TYPE_INT,
			&ch1_val, timestamp };
